...
| 1j | Run cell 2.5.14 (Ablation Table 1: LaTeX + plain text) | ❌ | <1 min | **cell added 2026-05-04**, aggregates results from 1c-1h, 1k-1m |
| 1k | Run cell 2.5.15 (Image-CV: Swin / ConvNeXt / Logit ensemble) | ❌ | ~30 min | **cell added 2026-05-04**, ready to run — fills baseline rows in Ablation Table 1 image-CV col |
| 1l | Run cell 2.5.16 (Image-CV: Binary-opt fusion) | ❌ | ~10 min | **cell added 2026-05-04**, ready to run |
| 1m | Run cell 2.5.17 (Feature ensemble: image-CV + patient-CV combined) | ❌ | ~30 min | **cell added 2026-05-04**, ready to run — separate baseline from binary-opt |
